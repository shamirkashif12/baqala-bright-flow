...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      // POS Checkout and Cashier Workspace are terminal-UI screens — roles-based
      ...
      // Control Tower has no dedicated DB module — supervisor oversight UI
  ...
  },
  {
    ...
    items: [
      ...
      // Coupons has no dedicated DB module — map to Finance until a Coupons module is added
  ...
  },
  {
    label: "Insights",
    items: [
      // Sales, KPI, BI all map to the Reports permission module
  ...
  },
  {
    ...
    items: [
      ...
      // Maintenance and Plans have no DB module — admin-only
...
export function AppSidebar() {
  ...
  // tenant_admin always sees everything.
  // Items with module: checked against the live DB permission map (canView).
  // Items with roles: use the static allowlist as fallback.
