...
namespace BaqalaPOS.Api.Migrations
{
    ...
    [Migration("20260804104938_RecreateDataProtectionKeysTable")]
    partial class RecreateDataProtectionKeysTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.ApprovalRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.CashierShift", b =>
                {
                    ...
                    b.Property<DateTime?>("OverdueFlaggedAt")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("overdue_flagged_at");

                    b.Property<Guid?>("OverdueOverrideBy")
                        .HasColumnType("char(36)")
                        .HasColumnName("overdue_override_by");

                    b.Property<DateTime?>("OverdueOverrideUntil")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("overdue_override_until");
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.CompanyProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.CustomerCoupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.Employee", b =>
                {
                    ...
                    b.Property<DateTime?>("LeavePolicyEffectiveFrom")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("leave_policy_effective_from");
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.MaintenanceTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.OrderDeliveryDetail", b =>
                {
                    b.Property<Guid>("OrderId")
                        .HasColumnType("char(36)")
                        .HasColumnName("order_id");
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.PosSettings", b =>
                {
                    ...
                    b.Property<decimal>("OnlineOrderingMaxOrderValueSar")
                        .HasColumnType("decimal(18,4)")
                        .HasColumnName("online_ordering_max_order_value_sar");

                    b.Property<decimal>("OnlineOrderingMinOrderAmountSar")
                        .HasColumnType("decimal(18,4)")
                        .HasColumnName("online_ordering_min_order_amount_sar");
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.SupplierDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.TaxFeeRule", b =>
                {
                    ...
                    b.Property<decimal>("MinimumExciseAmount")
                        .HasColumnType("decimal(18,4)")
                        .HasColumnName("minimum_excise_amount");
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.TenantPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.Property<string>("GatewayJwtAudience")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)")
                        .HasColumnName("gateway_jwt_audience");

                    b.Property<string>("GatewayJwtIssuer")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)")
                        .HasColumnName("gateway_jwt_issuer");

                    b.Property<string>("GatewayJwtKey")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)")
                        .HasColumnName("gateway_jwt_key");
                    ...
                    b.Property<int?>("MaxTerminalsPerBranch")
                        .HasColumnType("int")
                        .HasColumnName("max_terminals_per_branch");

                    b.Property<int?>("MaxUsersPerBranch")
                        .HasColumnType("int")
                        .HasColumnName("max_users_per_branch");
                    ...
                    b.Property<string>("WebhookSharedSecret")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)")
                        .HasColumnName("webhook_shared_secret");

                    b.HasKey("Id");

                    b.ToTable("tenant_plan");
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.MaintenanceTicket", b =>
                {
                    b.HasOne("BaqalaPOS.Api.Models.Device", "Device")
                        .WithMany()
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.Notification", b =>
                {
                    ...
                    b.HasOne("BaqalaPOS.Api.Models.User", "TriggeredByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.OrderDeliveryDetail", b =>
                {
                    b.HasOne("BaqalaPOS.Api.Models.Order", "Order")
                        ...
                        .HasForeignKey("BaqalaPOS.Api.Models.OrderDeliveryDetail", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BaqalaPOS.Api.Models.StockCount", b =>
                {
                    ...
                    b.HasOne("BaqalaPOS.Api.Models.User", "CompletedByUser")
                        .WithMany()
                        .HasForeignKey("CompletedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BaqalaPOS.Api.Models.User", "ReviewedByUser")
                        .WithMany()
                        .HasForeignKey("ReviewedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BaqalaPOS.Api.Models.User", "StartedByUser")
                        .WithMany()
