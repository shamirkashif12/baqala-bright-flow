...
const ALL_MODULES = [
  "Dashboard",
  "POS", "Cashier Workspace", "Customer Display", "Cashier Shifts",
  ...
  "Employees", "HR Attendance", "HR Shifts", "Leave Management", "HR Master Data",
  "Users", "Roles",
...
const RECOMMENDED: Record<string, RecommendedEntry[]> = {
  ...
  "Manager": [
    ...
    { module: "Customer Display",    flags: ["canView"] },
  ...
  "Marketing User": [
    ...
    { module: "Loyalty Program", flags: ["canView", "canCreate", "canEdit", "canExport"] },
