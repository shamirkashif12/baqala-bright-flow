    ...
    public static IEnumerable<RolePermission> BuildPermissions(Guid roleId, string roleName)
    {
        ...
        return roleName switch
        {
            "Tenant Administrator" => new[]
            {
                ...
                P(r, "Customer Display",    true,  true,  true,  true,  true,  true),
            ...
            "Branch Manager" => new[]
            {
                ...
                P(r, "Customer Display",    true,  false, false, false, false, false),
            ...
            "Storekeeper" => new[]
            {
                ...
                P(r, "Customer Display",    false, false, false, false, false, false),
