...
const ACTIVITY_GROUPS: { value: string; label: string; actions: string[] }[] = [
  ...
  { value: "inventory", label: "Inventory Adjustments / Wastage", actions: ["inventory_adjustment", "approve_inventory_adjustment", "reject_inventory_adjustment"] },
  // FRD §2.4 — stock transfers (incl. supplier returns, which are warehouse_to_supplier transfers)
  // and purchase receipts now write to the audit trail; surface them as their own review groups.
  { value: "stock_transfers", label: "Stock Transfers", actions: ["create_stock_transfer", "approve_stock_transfer", "reject_stock_transfer", "ship_stock_transfer", "receive_stock_transfer", "cancel_stock_transfer"] },
  { value: "purchase_receipts", label: "Purchase Receipts", actions: ["receive_purchase_order"] },
  { value: "stock_counts", label: "Stock Counts / Reconciliation", actions: ["start_stock_count", "complete_stock_count"] },
...
const ACTION_LABELS: Record<string, string> = {
  ...
  inventory_adjustment: "Wastage / adjustment recorded",
  approve_inventory_adjustment: "Wastage approved",
  reject_inventory_adjustment: "Wastage rejected",
  start_stock_count: "Stock count started",
  complete_stock_count: "Stock count completed",
  create_stock_transfer: "Stock transfer created",
  approve_stock_transfer: "Stock transfer approved",
  reject_stock_transfer: "Stock transfer rejected",
  ship_stock_transfer: "Stock transfer shipped",
  receive_stock_transfer: "Stock transfer received",
  cancel_stock_transfer: "Stock transfer cancelled",
  receive_purchase_order: "Purchase received",
